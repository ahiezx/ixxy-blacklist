...
if(mysqli_num_rows($result2) > 0)
{
 while($row = mysqli_fetch_array($result2))
 {
  ...
  $output .= "<li class='search_result'>".$platform."<a href='https://www.instagram.com/".$row["account"]."' target='_blank' class='text-white'>".$row["account"]."</a><p style='float:right;' class='text-success'>موثوق</p></li>";
 }
}
