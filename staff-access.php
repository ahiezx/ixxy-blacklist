						...
						switch ($_POST['add_type']) {
							case 'blacklist':
								...
								if(!empty($_POST['account']) and !empty($_POST['platform']) and !empty($_POST['proof'])) {
									...
									$sus = mysqli_real_escape_string($mysql, htmlspecialchars(trim($_POST['blacklist_type'])));
									...
									$query = mysqli_query($mysql, "INSERT INTO blacklist (name,platform,number,proof,sus) VALUES('$name','$platform','$number','$proof','$sus');");
									$query2 = mysqli_query($mysql, "INSERT INTO audit (date,username,action,target,ip) VALUES('$today','$username','+ Blacklist/Sus','$name','$ip');");
							...
							case 'middle':
								if(isset($_POST['account']) and isset($_POST['deals']) and isset($_POST['platform'])) {
								if(!empty($_POST['account']) and !empty($_POST['deals']) and !empty($_POST['platform'])) {

									$name = mysqli_real_escape_string($mysql, htmlspecialchars(trim($_POST['account'])));
									$deals = mysqli_real_escape_string($mysql, htmlspecialchars(trim($_POST['deals'])));
									$platform = mysqli_real_escape_string($mysql, htmlspecialchars(trim($_POST['platform'])));

									$query = mysqli_query($mysql, "INSERT INTO middle (account,deals,platform) VALUES('$name','$deals','$platform');");
									$query2 = mysqli_query($mysql, "INSERT INTO audit (date,username,action,target,ip) VALUES('$today','$username','+ Middle','$name','$ip');");
						...
						switch ($_POST['remove_type']) {
							...
							case 'middle':
								...
								if(!empty($_POST['account'])) {
									...
									$query = mysqli_query($mysql, "DELETE FROM middle WHERE account='$name';");
									$query2 = mysqli_query($mysql, "INSERT INTO audit (date,username,action,target,ip) VALUES('$today','$username','- Middle','$name','$ip');");
		...
		<div class="container pt-3">
			<div class="row">
				<div class="col-12 pb-3 pt-3 text-white" style="border-top: solid white 1px;border-right: solid white 1px;border-left: solid white 1px;border-radius: 3px;">
					...
					<h6 class="mb-0 p-2 text-center" style="border:solid white 1px;">Staff Access v1.2</h1>

				</div>

				<div class="col-6 p-5 text-white" style="border-bottom: solid white 1px;">
					
					<h6 class="mb-0 p-2 text-center" style="border:solid white 1px;">Add Middle<br>اضافة وسيط</h1>

					<form method="post" action="#">
						<input type="hidden" name="type" value="add">
						<input type="hidden" name="add_type" value="middle">
						<div class="form-group justificy-content-center mx-auto text-center mt-3">
							<label for="middle_name">Middle Account<br>حساب الوسيط</label>
							<input type="text" name="account" class="form-control mb-2" id="middle_name" placeholder="حساب الوسيط - Middle Account">
							<input type="number" name="deals" class="form-control mb-2" id="middle_name" placeholder="اعداد المعاملات - Deals">
				...
				<div class="col-6 p-5 text-white" style="border-bottom: solid white 1px;">
					...
					<h6 class="mb-0 p-2 text-center" style="border:solid white 1px;">Remove Middle<br>حذف وسيط</h1>

					<form method="post" action="#">
						<input type="hidden" name="type" value="remove">
						<input type="hidden" name="remove_type" value="middle">
						<div class="form-group justificy-content-center mx-auto text-center mt-3">
							
							<label for="middle_name">Middle Account<br>حساب الوسيط</label>
							<input type="text" class="form-control mb-2" id="middle_name" name="account" placeholder="حساب الوسيط - Middle Account">		
							<input type="submit" class="btn btn-primary btn-sm mt-2">
				...
				<div class="col-6 p-5 text-white" style="border-bottom: solid white 1px;">
					...
					<form method="post" action="#">
						...
						<div class="form-group justificy-content-center mx-auto text-center mt-3">
							...
							<label for="shop_name">Scammer Account<br>حساب المحتال</label>
							<input type="text" class="form-control mb-2" id="shop_name" name="account" placeholder="حساب المتجر - Shop Account">		
							<input type="text" class="form-control mb-2" id="proof" name="proof" placeholder="الاثبات - Proof">	
							<input type="text" class="form-control mb-2" id="number" name="number" placeholder="Phone Number">						
							<select id="platforms" name="platform" class="form-control">
							  <option value="Instagram">Instagram</option>
							  <option value="Snapchat">Snapchat</option>
							  <option value="Whatsapp">WhatsApp</option>
							...
							<p class="mt-2"></p>
							<input type="radio" name="blacklist_type" value="0" checked>Blacklist<br>
							<input type="radio" name="blacklist_type" value="1">Suspicious<br>
				...
				<div class="col-6 p-5 text-white" style="border-bottom: solid white 1px;">
					...
					<form method="post" action="#">
						...
						<div class="form-group justificy-content-center mx-auto text-center mt-3">
							...
							<label for="shop_name">Shop Account<br>حساب المحتال</label>
							<input type="text" class="form-control mb-2" id="shop_name" name="account" placeholder="حساب المتجر - Shop Account">							
							<input type="submit" class="btn btn-primary btn-sm mt-2">
					...
					<div class="col-12 p-5 text-white">
						...
						<table style="width:100%">
						  ...
						  <tr>
						    ...
						    <td class="text-warning">'.strtolower($row['username']).'</td>
