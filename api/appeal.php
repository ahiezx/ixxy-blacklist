			...
			if ($_POST['type'] == "whitelist" or $_POST['type'] == "report") {
				...
				if(preg_match('/[^A-Za-z0-9-.-_\-]/', $name)) {
					...
					if(mysqli_num_rows($exist) > 0) {
						...
						echo json_encode(array("message"=>"Your report has been submitted"));
					}
					else {
						...
						if($query) {
							...
							echo json_encode(array("message"=>"An error occurred please try again or report it to website owner"));
						}
					}
