...
<body style="background-color: black;">
	...
	<div class="container-fluid text-center text-white" style="text-transform: uppercase;">
		...
		<h3 class="mb-3 mt-5" style="color:#913d88;" data-aos="fade-up" data-aos-duration="1200">★ Sponsored Legitimate markets ★</h3>
		...
		<h3 class="mb-3 mt-5 text-success" data-aos="fade-up" data-aos-duration="1500">Legitimate markets</h3>
		<div class="row text-center justificy-content-center d-flex mx-auto">
			<?php
			$platform_data2 = '';
